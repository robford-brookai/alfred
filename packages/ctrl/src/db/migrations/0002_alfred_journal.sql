...
--
-- Hermes ships per-(user, channel) sessions (e.g. agent:main:telegram:dm:100000000)
...
--
-- Sir is ONE principal whether he messages from Telegram chat 100000000, his
...
CREATE TABLE IF NOT EXISTS alfred_principal (
  ...
  display_name TEXT NOT NULL,            -- 'Test User'
