...
test("isProbablyValidSlackBotToken: accepts xoxb-…, rejects everything else", () => {
  assert.equal(
    isProbablyValidSlackBotToken("xoxb-XXXXXXXXXXXXXXXXXXXX"),
    true,
  );
  assert.equal(isProbablyValidSlackBotToken("  xoxb-XXXXXXXXXXXXXXXXXXXX  "), true);
...
test("isProbablyValidSlackAppToken: accepts xapp-…, rejects everything else", () => {
  assert.equal(
    isProbablyValidSlackAppToken("xapp-XXXXXXXXXXXXXXXXXXXX"),
    true,
  );
